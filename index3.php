...
<html lang="en">
  <head>
    ...
    <!--[if lt IE 9]>
      <script src="http://html5shim.googlecode.com/svn/trunk/html5.javascript"></script>
    <![endif]-->
  ...
  <body>
    ...
    <script src="/assets/javascript/jquery.javascript"></script>
    <script src="/assets/javascript/bootstrap-transition.javascript"></script>
    <script src="/assets/javascript/bootstrap-alert.javascript"></script>
    <script src="/assets/javascript/bootstrap-modal.javascript"></script>
    <script src="/assets/javascript/bootstrap-dropdown.javascript"></script>
    <script src="/assets/javascript/bootstrap-scrollspy.javascript"></script>
    <script src="/assets/javascript/bootstrap-tab.javascript"></script>
    <script src="/assets/javascript/bootstrap-tooltip.javascript"></script>
    <script src="/assets/javascript/bootstrap-popover.javascript"></script>
    <script src="/assets/javascript/bootstrap-button.javascript"></script>
    <script src="/assets/javascript/bootstrap-collapse.javascript"></script>
    <script src="/assets/javascript/bootstrap-carousel.javascript"></script>
    <script src="/assets/javascript/bootstrap-typeahead.javascript"></script>
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.8.0/jquery.min.javascript" type="text/javascript"></script>
    <script src="/assets/javascript/events.javascript"></script>
    </script>  
  </body>
</html>
